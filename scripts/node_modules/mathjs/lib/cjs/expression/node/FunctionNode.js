    ...
    if ((0, _is.isSymbolNode)(this.fn)) {
      ...
      if (isRaw) {
        ...
        return function evalFunctionNode(scope, args, context) {
          ...
          return fn(rawArgs, math, (0, _extends2["default"])({}, scope, args));
        };
      } else {
        // "regular" evaluation
      ...
      return function evalFunctionNode(scope, args, context) {
        ...
        return isRaw ? object[prop](_rawArgs, math, (0, _extends2["default"])({}, scope, args)) // "raw" evaluation
      ...
      return function evalFunctionNode(scope, args, context) {
        ...
        return isRaw ? fn(_rawArgs2, math, (0, _extends2["default"])({}, scope, args)) // "raw" evaluation
